...
noMayusculas = '[^A-Z]'
minusculas = '[a-z]'
firstPattern = noMayusculas + mayusculas + mayusculas + mayusculas + minusculas + mayusculas + mayusculas + mayusculas + noMayusculas

myRegex = re.compile(firstPattern)

finalList = myRegex.findall(inStr)
print finalList
